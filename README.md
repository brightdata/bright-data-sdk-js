...
|--------------------------|-----------------------------|-------------------------------------
| **Scrape every website** | `scrape`                    | Scraping every website using unti bot-detection capabilities
| **Web search**           | `search`                    | Search on google and other search engines by query (supports batch searches)
